        ...
        Connection = RunService.RenderStepped:Connect(function()
            ...
            if ESP_Enabled and Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Character:FindFirstChild("Humanoid") and Player ~= LocalPlayer then
                ...
                if OnScreen then
                    ...
                    HealthBar.Color = Color3.fromHSV(HealthPercent * 0.3, 1, 1) -- 动态颜色
...
function UI:Intro(on_finish)
    ...
    title.Text = UIUtils:Clean("辰凌自瞄Hub（姐姐 用完整版）")
    ...
    local btn_full = CreateBtn("汉化完整版", 0.7)
